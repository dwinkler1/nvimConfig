-- Minimal Markdown checkbox toggler: `:ToggleCheckbox` (mapped to <leader>mc).
-- Toggles `- [ ]`/`- [x]` (and numbered `N. [ ]`/`N. [x]`) on the current line;
-- creates a checkbox on lines without one.
